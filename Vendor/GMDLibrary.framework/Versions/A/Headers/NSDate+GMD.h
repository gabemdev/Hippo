...
@interface NSDate (GMD)

//-------------
// EXAMPLE
//-------------
/*
 NSBundle *bundle = [NSBundle bundleWithPath:[[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"GMDLibraryResources.bundle"]];
	NSLog(@"%@", NSLocalizedStringFromTableInBundle(@"less than %d seconds", @"GMDCategories", bundle, nil));
 */
 ...
 */
+ (NSDate *)gmd_dateFromISO8601String:(NSString *)iso8601String;
...
/**
 ...
 @see timeInWordsFromTimeInterval:includingSeconds:
 */
- (NSString *)gmd_timeInWordsIncludingSeconds:(BOOL)includeSeconds;
...
/**
 ...
 @see timeInWordsIncludingSeconds:
 */
+ (NSString *)gmd_timeInWordsFromTimeInterval:(NSTimeInterval)intervalInSeconds includingSeconds:(BOOL)includeSeconds;
