 ...
 */
- (BOOL)gmd_containsString:(NSString *)string;
 ...
 */
- (NSString *)gmd_HMACDigestWithKey:(NSString *)key algorithm:(CCHmacAlgorithm)algorithm;
 ...
 */
- (NSComparisonResult)gmd_compareToVersionString:(NSString *)version;
 ...
 */
- (NSString *)gmd_stringByEscapingForURLQuery;
 ...
 */
- (NSString *)gmd_stringByUnescapingFromURLQuery;
 ...
 */
+ (NSString *)gmd_stringWithBase64String:(NSString *)base64String;
 ...
 */
- (NSRange)gmd_composedRangeWithRange:(NSRange)range;
 ...
 */
- (NSString *)gmd_composedSubstringWithRange:(NSRange)range;
 ...
 */
- (NSRange)gmd_wordRangeAtIndex:(NSUInteger)index;
